...
import { Category, TransformedMeal } from "../../types/meal.types";
...
export default function HomeScreen() {
  ...
  const [featuredRecipe, setFeaturedRecipe] = useState<TransformedMeal | null>(
    null
  );
  ...
  if (loading && !refreshing)
    return (
      <LoadingSpinner message="Loading delicions recipes..." size={"large"} />
    );
  return (
